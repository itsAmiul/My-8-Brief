<?php
    ...
    require_once("../../../../Controllers/Address.php");
?>
...
<body>
                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    <div class="hidden sm:ml-6 sm:block">
                        <div class="flex space-x-4">
                            ...
                            <a href="Address.php" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium">Address</a>
                            ...
                            <a href="Permitions.php" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Permition</a>
                        </div>
                    </div>
                </div>
                <a href="Address.php?logout" class="text-red-600 hover:bg-gray-300 hover:text-red rounded-md px-3 py-2 text-sm font-medium">Log Out</a>
            </div>
        </div>
    </nav>
    ...
    <div class="mx-auto max-w-7xl mt-12 pl-8 pr-2">
        ...
        <div class="relative flex h-16 items-center justify-between mb-5">
            <h1 class="text-2xl font-extrabold dark:text-white" >/ Admin / Data / Address</h1>
            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" >Add New Address</button>
        </div>
