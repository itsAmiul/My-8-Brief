...
<body>
    ...
    <nav class="bg-gray-800">
        <div class="mx-auto max-w-7xl px-2 ">
            <div class="relative flex h-16 items-center justify-between">
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    <div class="hidden sm:ml-6 sm:block">
                        <div class="flex space-x-4">
                            ...
                            <a href="Atms.php" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium">Atm</a>
                ...
                <a href="Atms.php?logout" class="text-red-600 hover:bg-gray-300 hover:text-red rounded-md px-3 py-2 text-sm font-medium">Log Out</a>
            </div>
        </div>
    </nav>
    ...
    <div class="mx-auto max-w-7xl mt-12 pl-8 pr-2">
        ...
        <div class="relative flex h-16 items-center justify-between mb-5">
            <h1 class="text-2xl font-extrabold dark:text-white" >/ Admin / Data / Atm</h1>
            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" >Add New Atm</button>
        </div>
